...
\begin{center}
\large\bf Benjamin Bolte \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
1079 N Jamestown Road \\ Decatur, GA 30033 \\ (360) 713-7141 % Your address and phone number
\end{center} 
\vfill

\signature{Benjamin Bolte} % Your name for the signature at the bottom
